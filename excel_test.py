# Обрабатывает файлы xlsx в своем каталоге.
# Ищет слова из словаря dictionary.txt
# Создает копии файлов с добавлением "_1" в имя
# В создаваемых файлах в конце пишет встретившиеся в строчке исходного файла
# значения из словаря и столбцы в которых встретил значения
...
for tmp_file in xls_files:
    ...
    try:
        ...
        print('Скорее всего слишком большой исходный файл.')
        print('Можно разбить его на несколько. Желательно не более 10 000.')
        print('Иногда проскакивает больше, но это зависит и от количества столбцов.')
        print('В бухгалтерских выгрузках бывает более 200 (столбцов)')
